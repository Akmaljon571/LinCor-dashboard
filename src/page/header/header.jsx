...
function HeaderMe() {
    const {head, vaqt, setLang, lang, dark, setDark, soat, setMenubar, menubar} = useStart()
    ...
    return (
        <header  className={dark ? "header_father-dark header_father" : 'header_father'}>
            <img onClick={() =>  setMenubar(!menubar)} className='hum' src={hum} alt="hum" />
